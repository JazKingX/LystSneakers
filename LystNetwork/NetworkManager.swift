...
public class NetworkManager {
    ...
    // Set URL
    public func getUrl(_ gender: Gender, category: String?) -> String {
    ...
    public func requestData(_ stringUrl: String, success:@escaping (JSON) -> Void, failure:@escaping (Error) -> Void) {
        print("Request Data")
    ...
    public func getObjects(completionHandler : @escaping ([Product]) -> (),_ urlString:String) {
    ...
    public func getCategories(completionHandler : @escaping ([String]) -> (),_ urlString:String) {
